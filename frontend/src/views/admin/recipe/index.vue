  ...
  <div class="admin-recipe">
    ...
    <div class="search-bar">
      <el-form :inline="true" :model="searchForm">
        <el-form-item label="菜谱名称">
          <el-input v-model="searchForm.title" placeholder="菜谱名称" clearable></el-input>
        </el-form-item>
    ...
    <div class="table-wrapper">
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="title" label="菜谱名称" min-width="150" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="700px">
      <el-form :model="form" :rules="rules" ref="form" label-width="80px">
        <el-form-item label="菜谱名称" prop="title">
          <el-input v-model="form.title" placeholder="请输入菜谱名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="食材">
          <el-input v-model="form.ingredients" type="textarea" :rows="4" placeholder="请输入食材"></el-input>
        </el-form-item>
        <el-form-item label="步骤">
          <el-input v-model="form.steps" type="textarea" :rows="6" placeholder="请输入制作步骤"></el-input>
        </el-form-item>
        <el-form-item label="小贴士">
          <el-input v-model="form.tips" type="textarea" :rows="2" placeholder="请输入小贴士"></el-input>
        </el-form-item>
        <el-form-item label="状态">
...
<script>
import { getRecipeList, getRecipeCategoryList, saveRecipe, deleteRecipe } from '@/api/recipe'
...
export default {
  ...
  methods: {
    ...
    handleStatus(row) {
      ...
      this.$confirm(`确定要${action}该菜谱吗？`, '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(async () => {
        try {
          await saveRecipe({ id: row.id, status: newStatus })
